...
const $$Layout = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate(_a || (_a = __template(['<html lang="es"> <head><meta charset="UTF-8"><meta name="viewport" content="width=device-width"><link rel="icon" type="image/svg+xml" href="/favicon.svg"><title>', "</title>", "<script>\n			// Aplicar dark mode antes de que se renderice la p\xE1gina para evitar flash\n			const darkMode = localStorage.getItem('biblia-dark-mode');\n			if (darkMode === 'true' || (darkMode === null && window.matchMedia('(prefers-color-scheme: dark)').matches)) {\n				document.documentElement.classList.add('dark');\n			}\n		<\/script>", '</head> <body class="bg-amber-50/70 dark:bg-gray-900 min-h-screen transition-colors duration-300"> ', " </body></html>"])), title, renderComponent($$result, "ClientRouter", $$ClientRouter, {}), renderHead(), renderSlot($$result, $$slots["default"]));
